...
export default function Navbar() {
  ...
  return (
  <Disclosure as="nav" className="bgImg bg-green-700 ">
    <div className="h-[150px] pt-[70px] mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
    ...
    //         </div>
    //       </div>
    //       <div className="absolute inset-y-0 right-0 mt-[-20px] flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0"></div>
    //     </div>
    //   </div>
